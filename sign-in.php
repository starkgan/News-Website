...
<?php
  ...
  if(isset($_POST['email'])){
    ...
    /*this code is for searching for the signed in user 
    to check if the details even exist */
     ...
     $result = $conn->query($sql);
        ...
        header("Location:index.php");
         ...
         echo "<p style='color:red;text-align:center;'>Invalid Login Credintials</p>";
...
<html lang="en">
    <head>
        ...
        <title>MMS News - Sign In Page</title>
