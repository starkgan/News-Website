...
include_once('config.php');
       ...
       if($password == $confirm_password) {
            ...
            //this is to encrypt a password

            $encrypted_password = hash('md5',$password);

             //this is to encrypt a password

             $sql = "INSERT INTO users(email, firstname, surname, password) 
             VALUES('$email', '$firstname', '$surname', '$encrypted_password')";
...
<html lang="en">
    <head>
        ...
        <title>MMS News - Sign Up Page</title>
