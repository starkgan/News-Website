...
<html lang="en">
    <head>
        ...
        <title>MMS News-My Account Page</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 header-info">
                            <h4 style="margin-left:-20px;">
                                <span class="d-block text-primary" style="color:#2AB2E3!important">Welcome to Your Account</span>
                            </h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <h2 class="mb-4">Let's <span style="color:#2AB2E3!important">begin</span></h2>
                            <p>By Getting You To Upload Your Article</p>
                            <?php echo $message; ?>
                            <form class="contact-form me-lg-5 pe-lg-3" action="process.php" method="POST" enctype="multipart/form-data" role="form">
                
                                <div class="form-floating my-4">
                                    Title:
                                    <input type="subject" name="title" id="subject"class="form-control" required placeholder="Title">
                                </div>

                                <div class="form-floating mb-4">
                                    Article:
                                    <textarea id="message" name="article" class="form-control" placeholder="Article" required style="height: 160px"></textarea>
                                </div>

                                <div class="form-floating my-4">
                                <input type="file" name="fileToUpload" class="inp">
